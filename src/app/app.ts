...
import { ImagenesModel } from '../app/models/imagenes.model';
import { FormBuilder, Validators } from '@angular/forms';
import Swal from 'sweetalert2';
import { ImagenesService } from '../app/services/imagenes.services';
...
export class AppComponent implements OnInit {
  fb: FormBuilder = new FormBuilder();  // Inicialización directa
  private apiUrl = 'AQUI COLOCAR LA URL DE SU AP CREADA'; // URL de tu API
  ...
  // Inicializa el formulario después de inyectar FormBuilder
